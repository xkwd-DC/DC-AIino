...
近期硬 ddl：
  ...
  🚨 5-21   CRAIC 报名表打印 + 三人签字 + 学院盖章
  🚨 5-23 09:00  CRAIC 三份材料提交 caairobot.com (Issue #12) ← 最近硬 ddl
...
**P0 风险**：周煜楠 5/14 至今 0 通讯 → 5/21 签字到场风险。已起草 v1/v2/v3 ping 文案（[04_周煜楠紧急ping文案.md](_craic/04_周煜楠紧急ping文案.md)），潘今晚发 v1。

**R² 口径策略**：5/17 晚用户拍板 CRAIC 三份材料**直接切换至务实路线** R²=0.5647（10 种子均值实测上限）。三份材料的摘要 / §7.1.2 / 表 2 / 表 3 / 查新结论已统一改写。Att-LSTM 务实路线 R² 数字由熊鑫在 backend/models 用 paper_panel_v3 + raw Y 实测后补入（Issue #6 已派任务）。
